...
class RestaurantTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.localtionName.text = restaurantLocations[indexPath.row]
        cell.typeName.text = restaurantTypes[indexPath.row]
        cell.thumbnailNmae.image = UIImage(named: restaurantImages[indexPath.row])
